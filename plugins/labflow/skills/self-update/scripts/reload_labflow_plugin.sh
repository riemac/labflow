...
usage() {
  cat <<'EOF'
Usage:
  reload_labflow_plugin.sh [--marketplace <id>] [--root <path>]

Reloads the local Labflow Codex plugin marketplace by running:
...
cache_root="${HOME}/.codex/plugins/cache/${marketplace_id}/labflow"
...
printf 'Reload complete. Start a new Codex session to observe refreshed skill instructions.\n'
