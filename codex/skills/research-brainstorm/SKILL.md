...
Generate research method candidates from first principles, then critique each one. Use it in normal Codex conversation when the user needs scientific ideation rather than a software plan.
