...
- During ordinary development, proactively notice stale, missing, duplicated, or conflicting guidance. Before editing existing documents for that reason, use an available user-input tool to show the affected files and proposed maintenance scope.
