...
description: 外部资料调研编排技能。用于第三方库/API、官方文档、上游源码、版本迁移、论文/PDF、GitHub release/issue/PR，以及高噪音/低信噪比的深度外部调研。默认优先 ctx7 CLI / find-docs；gh CLI 仅在需要 GitHub 证据时辅助；高噪音调研强烈委派内置 scout subagent。
---
