...
Generate research method candidates from first principles, then critique each one. This is an ability skill: use it inside the labflow develop stage or any normal agent when the user needs scientific ideation rather than a software plan.
